...
- データを同期した状態で記録する
- 着水時にデータをロストしない
- 大型のかっくきで急速な動きをしないことを念頭に置いてデータレートを決定する
  - データレートは大体10~20Hz程度であれば大丈夫
...
## 質量概算
- 資料なかった…　ごめん
- 毎年，機体のコンセプトによって軽めにするか，重めにするかが変わるため，製作の際は設計の人と確認しながら電装の重量を減らしたりする(増やす場合は電装でなくても錘つけるといった対応ができるため，必ずしも電装が重量を増やす必要はないかも…)
- 重量を減らすために電装部品を減らす場合は電装部品をもっとコンパクトにできないか(センサーを変える，基板を小さくする，材料を軽いものにするなど)を考える。それでもダメな場合は電装の代用が効く部品を減らす。
- 重心の位置によっては場所が変わる場合もあることに注意(今回はメインとかエアデータの部分が全組の重測で変わった)
